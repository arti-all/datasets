package org.apache.maven.shared.interpolation.interpolators;
...
import org.apache.maven.shared.interpolation.ValueSource;
...
public class InterpolationContextCache
{
     ...
     * @throws IOException
     */
    public boolean resolvesToSameValues( ValueSource interpolator, DefaultInterpolationState interpolationState )
        throws IOException
    {
        if ( !hasCacheFile() )
        {
